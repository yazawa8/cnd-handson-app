...
def create_Request(stub: role_pb2_grpc.RoleServiceStub, command: str, arguments: list[str]) -> Any:
    ...
    if command == "create":
        ...
        return f"id={response.role.id}, name={response.role.name}, description={response.role.description}"
    elif command == "get":
...
if __name__ == "__main__":
    ...
    parser.add_argument("command", choices=["create", "get", "update","delete","list"], help="Command to execute")
